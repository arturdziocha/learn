...
public class Project {
    public static void main(String[] args) {
        ...
        answers.forEach((key, val) -> {
            ...
            if (answer.equals(val)) {
                ...
                if (answers.containsValue(answer)) {
                    String k = getKeyFromMap(answers, answer);
                    System.out
        ...
        /*
         * Old Scanner scanner = new Scanner(System.in);
         * System.out.println("Input the number of cards:"); int numOfCards =
         * Integer.parseInt(scanner.nextLine()); String[] nameOfCards = new
         * String[numOfCards]; String[] definitions = new String[numOfCards];
         * String[] cards = new String[numOfCards]; for (int i = 0; i <
         * numOfCards; i++) { System.out.println("The card #" + (i + 1) + ":");
         * nameOfCards[i] = scanner.nextLine();
         * System.out.println("The definition of the card #" + (i + 1) + ":");
         * definitions[i] = scanner.nextLine(); } for (int i = 0; i <
         * numOfCards; i++) { System.out.println("Print the definition of \"" +
         * nameOfCards[i] + "\":"); String answer = scanner.nextLine(); if
         * (answer.equals(definitions[i])) {
         * System.out.println("Correct answer."); } else {
         * System.out.println("Wrong answer. The correct one is \"" +
         * definitions[i] + "\"."); } }
         */
    }

    private static String getKeyFromMap(Map<String, String> map, String value) {
        return map
                .entrySet()
                .stream()
                .filter(es -> es.getValue().equals(value))
                .findFirst()
